  ...
  return (
    <div className="w-[84vw] space-y-8 md:space-y-20">
      <div className="about-card p-4 md:p-8 flex flex-col xl:flex-row gap-4 md:gap-16 justify-between drop-shadow-2xl drop-shadow-black/80">
        <img
          className="w-full object-cover rounded-2xl h-auto xl:w-[40vw]"
          src={meImg}
          alt="My Image"
        />
        <div className="flex flex-col gap-0 md:gap-4 p-0 md:p-8 text-white">
          <h1 className="text-4xl md:text-6xl font-medium drop-shadow-sm drop-shadow-black/50">
            About Me
          </h1>
          <h2 className="text-base md:text-xl font-light text-white drop-shadow-sm drop-shadow-black">
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-xl font-light drop-shadow-sm drop-shadow-black">
              Google Drive
            </h3>
            <a href="https://drive.google.com/drive/folders/1Ioo7Ic3C709votNGF3qlLorwnNNzAWNC?usp=sharing">
              <img
                src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fstatic.vecteezy.com%2Fsystem%2Fresources%2Fpreviews%2F022%2F613%2F023%2Fnon_2x%2Fgoogle-drive-icon-logo-symbol-free-png.png&f=1&nofb=1&ipt=b0e39044f999c57fbdbeaffb1fea54f182b40abf0cdfaabc5ab1f813418673c1"
                alt="Google Drive logo"
                className="cursor-none w-10 md:w-15 h-auto drop-shadow-sm drop-shadow-black/40 hover:scale-110 transition-all duration-300"
              />
            </a>
          </div>
        </div>
      ...
      <div className="about-card p-4 md:p-8 flex flex-col gap-8 justify-between items-center text-base text-white drop-shadow-2xl drop-shadow-black/80">
        <h1 className="text-3xl md:text-6xl font-medium drop-shadow-sm drop-shadow-gray-600/80">
          Work Experience
        </h1>
        ...
        <div className="w-full drop-shadow-sm drop-shadow-gray-600/80">
          ...
          <span className="text-sm md:text-base">
            Certificate in Educational Program, Pre-Electrical Engineering
          </span>
        </div>
        <div className="w-full drop-shadow-sm drop-shadow-gray-600/80">
          <h2 className="text-lg md:text-4xl">
        ...
        <div className="w-full drop-shadow-sm drop-shadow-gray-600/80">
          <h2 className="text-lg md:text-4xl">
            Bachelor's Thesis: Hydroponic Plant Care RobotUniversity Project
          </h2>
          <ul className="text-sm md:text-base list-disc px-6">
            <li>
              Developed a mechanical structure capable of carrying up to 50 kg,
              including 5L of water and 5L of bio-solution.
            </li>
            <li>
              Integrated motor and transmission system using 12V DC gear motors,
              timing pulleys, and encoders for precise movement.
            </li>
            <li>
              Implemented temperature-based automatic mist spraying system using
              sensors and solenoid valves.
            </li>
            <li>
              Arduino microcontrollers/ ESP32-CAM to control actuators, monitor
              sensors, manage system logic and capture plant and send to Google
              Drive
            </li>
          </ul>
        </div>
        ...
        <div className="w-full drop-shadow-sm drop-shadow-gray-600/80">
          <div className="flex gap-4 items-center text-center">
            <h2 className="text-lg md:text-4xl">Online Shop</h2>
            <a className="text-lg md:text-2xl text-lime-400 cursor-none hover:scale-110 duration-300" href="https://online-shop-with-dummyjson.vercel.app">[Demo]</a>
          </div>
          <ul className="text-sm md:text-base list-disc px-6">
            <li>Fast and lightweight setup with Vite</li>
            <li>
              Simulated product listing and shopping cart using dummy data
            </li>
            <li>Modular architecture for components and pages</li>
            <li>Responsive Design</li>
          </ul>
        </div>
        <div className="w-full drop-shadow-sm drop-shadow-gray-600/80">
          <div className="flex gap-4 items-center text-center">
            <h2 className="text-lg md:text-4xl">Thailand Circuits Gps API</h2>
            <a className="text-lg md:text-2xl text-lime-400 cursor-none hover:scale-110 duration-300" href="https://thailandcircuitgpsapi.onrender.com">[Demo]</a>
            <a className="text-lg md:text-2xl text-blue-400 cursor-none hover:scale-110 duration-300" href="https://github.com/sbjame/ThailandCircuitGpsApi">[GitHub]</a>
          </div>
          <ul className="text-sm md:text-base list-disc px-6">
            <li>Circuit management (CRUD for Thailand racing circuits)</li>
            <li>User authentication & authorization (JWT)</li>
            <li>Weather integration with external API</li>
            <li>Cron jobs for updating weather data automatically</li>
            <li>File upload support (Cloudinary + Multer)</li>
        ...
        <div className="w-full drop-shadow-sm drop-shadow-gray-600/80">
          <div className="flex gap-4 items-center text-center">
            <h2 className="text-lg md:text-4xl">Thailand Circuits Gps Website</h2>
            <a className="text-lg md:text-2xl text-lime-400 cursor-none hover:scale-110 duration-300" href="https://thailand-circuit-gps.vercel.app">[Demo]</a>
            <a className="text-lg md:text-2xl text-blue-400 cursor-none hover:scale-110 duration-300" href="https://github.com/sbjame/ThailandCircuitGps">[GitHub]</a>
          </div>
          <ul className="text-sm md:text-base list-disc px-6">
            <li>Interactive map of racing circuits in Thailand</li>
            <li>Display track location and details</li>
            <li>Search and select tracks easily</li>
            <li>Weather data integration (via API)</li>
